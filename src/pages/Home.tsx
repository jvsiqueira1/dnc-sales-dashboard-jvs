...
// TYPES
import { HighlightData, StarsData, NewsData, CustomChartProps } from '@/types'
...
function Home() {
  ...
  } = useGet<HighlightData[]>('sales/highlights')
  const {
    data: salesMonthData,
            ...
            {!salesMonthError && (
              ...
              >
                {!salesMonthLoading && salesMonthData && (
                  <>
                    <StyledH2 className="md-1">Valor de vendas no mês</StyledH2>
                    <CustomChart
            ...
            {!newsError && (
              ...
              >
                {!newsLoading && newsData && (
                  <>
                    <StyledH2 className="md-1">Noticias relevantes</StyledH2>
                    <CustomTable
